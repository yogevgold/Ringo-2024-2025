...
public class KeyPositions {
    // BLUE FAR
    public static Pose2d BLUE_FAR_FROM_BUCKET_SPAWN = new Pose2d(-12, 70,  Math.toRadians(-90));
    ...
    // RED FAR
    public static Pose2d RED_FAR_FROM_BUCKET_SPAWN = new Pose2d(12, -70, Math.toRadians(90));
