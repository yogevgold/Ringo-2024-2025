        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.y) {
                ...
                newActions.add(new SequentialAction(
                        pincer.PincerPosition(Values.ARM_OUT, Values.TURN_OUT, Values.ROLL_OUT, Values.GRAB_OPEN)
                ));
            }
...
//            }
            ...
            if (gamepad2.a) {
                newActions.add(new SequentialAction(
                        pincer.PincerPosition(Values.ARM_IN, Values.TURN_IN, Values.ROLL_IN, Values.GRAB_OPEN)
                ));
            }
            ...
            if (gamepad2.b) {
                RobotOpen = true;
                newActions.add(new SequentialAction(
                        pincer.PincerPosition(Values.ARM_OUT, Values.TURN_OUT, Values.ROLL_IN, Values.GRAB_OPEN)
                ));
            }

            if (gamepad2.y) {
                pincer.pincerGrab(Values.GRAB_CLOSE);
            }

            if (gamepad2.x) {
                pincer.pincerGrab(Values.GRAB_OPEN);
            }
