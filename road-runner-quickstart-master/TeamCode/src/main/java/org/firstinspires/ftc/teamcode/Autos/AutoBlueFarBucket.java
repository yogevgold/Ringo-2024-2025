...
@Autonomous
public class AutoBlueFarBucket extends LinearOpMode {
    MecanumDrive drive;
    Elevator elevator;
    Pincer pincer;
    Intake intake;
...
//        intake = new Intake(hardwareMap);
        ...
        Action trajectory2 =
                ...
                .splineToLinearHeading(KeyPositions.BLUE_RIGHT_BAR_POS_MID,Math.toRadians(30))
                .build();

        Action trajectory3 =
                drive.actionBuilder(KeyPositions.BLUE_RIGHT_BAR_POS_MID) //end of former trajectory (2)
                        .splineToLinearHeading(KeyPositions.BLUE_RIGHT_BAR_POS_BACK,Math.toRadians(30))
                        .build();

        Action trajectory4 =
                drive.actionBuilder(KeyPositions.BLUE_RIGHT_BAR_POS_BACK) //end of former trajectory (3)
